          ...
          <div className="mx-0">
            <div className="d-flex flex-column justify-content-center pb-5">
              <h5 className="text-center">
                BanffNB666 since 1675. Welcome to BanffNB666, your serene
                <br /> escape nestled in the heart of Banff National Park.
              </h5>
              <h5 className="text-center pt-3 text-nowrap">
                Any doubts? Don't worry, send us a message, we will reply to you soon.
              </h5>
            </div>
            <form ref={formRef} className="d-flex justify-content-center needs-validation" noValidate>
              <div className="mx-3">
